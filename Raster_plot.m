...
% By Simon Locke
%
% In this script you will make raster plots, which are a tool for visualizing 
% the trial-to-trial variability of neural data. You will need to do a few 
% things in order for this file to run.
% 
% 1) Set num_trials.
%
...
% Optional: Add a line of code to save your synthetic raster plots.
